...
And finally, register the new attributes with the autoloader.

```php
AnnotationRegistry::registerAutoloadNamespace('Prezent\\Doctrine\\Translatable\\Attribute', 'path/to/doctrine-translatable/lib');
```
